...
const StyledForm = styled_components__WEBPACK_IMPORTED_MODULE_4__["default"].form.withConfig({
  displayName: "form__StyledForm"
})(["display:flex;flex-direction:row;font-family:", ";@media ", "{flex-direction:column;}"], styles_theme__WEBPACK_IMPORTED_MODULE_1__.fontFamily, styles_responsiveSizes__WEBPACK_IMPORTED_MODULE_3__.devices.mobileL);
const Button = styled_components__WEBPACK_IMPORTED_MODULE_4__["default"].button.withConfig({
  displayName: "form__Button"
})(["margin-left:2em;background-color:", ";flex-grow:1;border-width:1px;color:white;border-style:solid;transition:0.3s background-color ease-in-out;border-width:0;border-radius:4px;font-family:\"montserrat\";letter-spacing:1px;text-transform:uppercase;:hover{background-color:white;color:", ";}@media ", "{justify-content:left;width:100%;margin-left:0;margin-top:20px;height:40px;}"], styles_theme__WEBPACK_IMPORTED_MODULE_1__.primaryAccentColor, styles_theme__WEBPACK_IMPORTED_MODULE_1__.secondaryAccentColor, styles_responsiveSizes__WEBPACK_IMPORTED_MODULE_3__.devices.mobileL);
const Field = styled_components__WEBPACK_IMPORTED_MODULE_4__["default"].div.withConfig({
