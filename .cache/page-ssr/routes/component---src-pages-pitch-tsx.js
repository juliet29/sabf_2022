...
/* harmony import */ var _navBar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3716);
...
/* harmony import */ var styles_globalStyles__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5002);
/* harmony import */ var _footer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(808);
// const Body = styled.body`
//   padding-left: ${edgePadding};
//   padding-right: 10em;
// `;
const Header=styled_components__WEBPACK_IMPORTED_MODULE_5__["default"].header.withConfig({displayName:"layout__Header",componentId:"sc-u0vulc-0"})(["margin-top:",";;padding-left:",";padding-right:",";div{height:1px;width:50%;background-color:white;}"],styles_theme__WEBPACK_IMPORTED_MODULE_2__/* .edgeSpace */ .bX+"em",styles_theme__WEBPACK_IMPORTED_MODULE_2__/* .edgeSpace */ .bX+"em",styles_theme__WEBPACK_IMPORTED_MODULE_2__/* .edgeSpace */ .bX+"em");const Layout=({pageTitle,children})=>{return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(styled_components__WEBPACK_IMPORTED_MODULE_5__.ThemeProvider,{theme:styles_theme__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .ZP},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(styles_globalStyles__WEBPACK_IMPORTED_MODULE_3__/* .GlobalStyle */ .Z,null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("html",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("title",null,pageTitle),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("body",{style:{height:"100%",minHeight:"100%"}},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_navBar__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z,null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Header,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1",null,pageTitle),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",null)),children),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_footer__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z,null)));};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Layout);
...
// EXTERNAL MODULE: ./src/styles/theme.ts
var theme = __webpack_require__(9649);
;// CONCATENATED MODULE: ./src/components/general/form.tsx
const StyledForm=styled_components_esm["default"].form.withConfig({displayName:"form__StyledForm",componentId:"sc-1agf4ih-0"})(["display:flex;flex-direction:row;"]);const Button=styled_components_esm["default"].button.withConfig({displayName:"form__Button",componentId:"sc-1agf4ih-1"})(["margin-left:2em;background-color:",";flex-grow:1;border-radius:0.12em;border-color:white;border-width:1px;color:white;border-style:solid;transition:0.3s background-color ease-in-out;:hover{background-color:",";}"],theme/* primaryAccentColor */.P5,theme/* secondaryAccentColor */.Hk);const Field=styled_components_esm["default"].div.withConfig({displayName:"form__Field",componentId:"sc-1agf4ih-2"})(["flex-grow:2;height:56px;border-radius:4px;position:relative;background-color:rgba(255,255,255,0.3);transition:0.3s background-color ease-in-out,0.3s box-shadow ease-in-out;:hover{background-color:#ffffff;box-shadow:0px 4px 20px 0px rgba(0,0,0,0.05);}:focus{background-color:#ffffff;box-shadow:0px 4px 20px 0px rgba(0,0,0,0.2);}:active{background-color:#ffffff;box-shadow:0px 4px 20px 0px rgba(0,0,0,0.2);}input{width:100%;height:56px;position:relative;padding:0px 16px;border:none;border-radius:4px;font-size:16px;font-weight:400;line-height:normal;background-color:transparent;color:#282828;outline:none;box-shadow:0px 4px 20px 0px transparent;transition:0.3s background-color ease-in-out,0.3s box-shadow ease-in-out,0.1s padding ease-in-out;}"]);////// end of styles
const sendToDatabase=email=>{var data=JSON.stringify({"email":email});var xhr=new XMLHttpRequest();xhr.withCredentials=false;xhr.addEventListener("readystatechange",function(){if(this.readyState===4){console.log(this.responseText);}});xhr.open("POST","https://sabf2022emails-1ad9.restdb.io/rest/emails");xhr.setRequestHeader("content-type","application/json");xhr.setRequestHeader("x-apikey","61fe7b1c6a791555010217f5");xhr.setRequestHeader("cache-control","no-cache");xhr.send(data);};const Form=({})=>{const{0:email,1:setEmail}=(0,index_js_.useState)("");const handleSubmit=evt=>{evt.preventDefault();alert(`Submitting Name ${email}`);sendToDatabase(email);};return/*#__PURE__*/index_js_default().createElement(StyledForm,{onSubmit:handleSubmit},/*#__PURE__*/index_js_default().createElement(Field,null,/*#__PURE__*/index_js_default().createElement("input",{type:"text",placeholder:"Email address",value:email,onChange:e=>setEmail(e.target.value)})),/*#__PURE__*/index_js_default().createElement(Button,{type:"submit"},"Submit"));};/* harmony default export */ const general_form = (Form);
// EXTERNAL MODULE: ./src/components/navigation/layout.tsx
var layout = __webpack_require__(3944);
;// CONCATENATED MODULE: ./src/pages/pitch.tsx
const Section=styled_components_esm["default"].section.withConfig({displayName:"pitch__Section",componentId:"sc-1e8ben0-0"})(["margin-top:",";padding-left:",";padding-right:",";"],theme/* edgeSpace */.bX+"em",theme/* edgeSpace */.bX+"em",theme/* edgeSpace */.bX+"em");const PitchPage=()=>{return/*#__PURE__*/index_js_default().createElement(layout/* default */.Z,{pageTitle:"Pitch Competition"},/*#__PURE__*/index_js_default().createElement(Section,null,/*#__PURE__*/index_js_default().createElement("h2",{style:{marginBottom:"1em"}},"Launching soon! Enter your email below to be notified about new updates."),/*#__PURE__*/index_js_default().createElement(general_form,null)));};/* harmony default export */ const pitch = (PitchPage);
