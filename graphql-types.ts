...
export type MarkdownContentQuery = { allMdx: { nodes: Array<{ id: string, body: string, frontmatter?: { title: string, number?: string | null } | null }> } };

export type MyQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type MyQueryQuery = { allMdx: { nodes: Array<{ id: string, body: string, frontmatter?: { title: string, number?: string | null } | null }> } };
