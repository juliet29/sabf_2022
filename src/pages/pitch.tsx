...
const PitchPage = () => {
  return (
    <LayoutPitch pageTitle="SABF Venture Competition">
      <WrapTest>
        <p>
          SIGN UP <StyledA href={updatesLink}>HERE</StyledA> FOR UPDATES ABOUT
          THE COMPETITION
        </p>

        <br />
        <ThinP>
          The SABF Venture Competition (April 16th, 2022) is an opportunity for
          founders to pitch to early-stage investors from across the globe.
          Judges and audience members include VC/angel investors from Silicon
          Valley and emerging markets alike. Competition winners will have the
          chance to enroll in a curated set of Stanford entrepreneurship
          courses, including access to the LEAD incubator and startup
          accelerator, well worth over $15,000.
        </ThinP>
        <br />
        ...
        <h2>Judges</h2>
        <p>
          To be announced. Sign up <StyledA href={updatesLink}>here</StyledA>{' '}
          for updates.
        </p>
        <br />
